...
#加深神经网络
# 78
# 1434/1434 [==============================] - 505s 352ms/step - loss: 0.0463 - accuracy: 0.9851 - val_loss: 0.6715 - val_accuracy: 0.8730
# 2868/2868 [==============================] - 181s 63ms/step - loss: 0.0512 - accuracy: 0.9834
# 79
# 1434/1434 [==============================] - 506s 353ms/step - loss: 0.0418 - accuracy: 0.9868 - val_loss: 0.6247 - val_accuracy: 0.8867
# 2868/2868 [==============================] - 181s 63ms/step - loss: 0.0236 - accuracy: 0.9923
# 训练模型
# 717/717 [==============================] - 45s 63ms/step - loss: 0.6247 - accuracy: 0.8867
# Test loss: 0.6247
# Test accuracy: 0.8867
# 模型评估
# 进行预测
# Class 0 Test Accuracy: 0.8939
# Class 1 Test Accuracy: 0.8785
# Class 2 Test Accuracy: 0.8865
# Class 3 Test Accuracy: 0.8393
# Class 4 Test Accuracy: 0.9581
# Class 5 Test Accuracy: 0.8720
# Class 6 Test Accuracy: 0.9205
# Class 7 Test Accuracy: 0.8538
# Class 8 Test Accuracy: 0.8293
# Class 9 Test Accuracy: 0.9348
# 开始模保存型
...
class ChannelAttention(Layer):
    ...
    def call(self, x):
        # 计算通道注意力权重
        channel_weights = K.softmax(K.dot(x, self.W) + self.b)
