        ...
        for filename in os.listdir(folder_path):
            ...
            try:
                ...
                for _ in range(3):  # 每个原始样本生成5个增强样本
                    ...
                    feature = extract_dynamic_mfcc(augmented_data,sample_rate)
...
def extract_dynamic_mfcc(audio_data, sample_rate):
    ...
    # Compute first-order delta MFCCs
    delta_mfccs = librosa.feature.delta(mfccs)

    # Compute second-order delta MFCCs (acceleration)
    delta2_mfccs = librosa.feature.delta(mfccs, order=2)

    # Stack the static, delta, and delta2 MFCCs vertically to create dynamic MFCCs
