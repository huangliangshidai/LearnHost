...
#无添加注意力机制会使测试集准确率降低，
# 增强泛化能力： 注意力机制可以使模型更加关注不同样本之间的差异，
# 从而提高模型的泛化能力。这有助于模型在处理新的、未见过的数据时表现更好。
#无添加注意力机制和动态MFCC，l2,
#batch_size=64, epochs=80，进行数据增强产生5倍，
# Epoch 79/80
# 1434/1434 [==============================] - 1143s 797ms/step - loss: 0.2377 - accuracy: 0.9232 - val_loss: 2.0788 - val_accuracy: 0.5573
# Epoch 80/80
# 1434/1434 [==============================] - 1118s 779ms/step - loss: 0.2243 - accuracy: 0.9270 - val_loss: 2.1058 - val_accuracy: 0.5549
# 717/717 [==============================] - 78s 109ms/step - loss: 2.1058 - accuracy: 0.5549
# Test loss: 2.1058
# Test accuracy: 0.5549
# 模型评估
# 进行预测
# Class 0 Test Accuracy: 0.3934
# Class 1 Test Accuracy: 0.5007
# Class 2 Test Accuracy: 0.6747
# Class 3 Test Accuracy: 0.4694
# Class 4 Test Accuracy: 0.7713
# Class 5 Test Accuracy: 0.3482
# Class 6 Test Accuracy: 0.6584
# Class 7 Test Accuracy: 0.4670
# Class 8 Test Accuracy: 0.5557
# Class 9 Test Accuracy: 0.7286
# 开始模保存型
# 定义数据增强函数
