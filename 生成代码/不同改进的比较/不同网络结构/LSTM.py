...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Flatten, Dense, Dropout,LSTM, Bidirectional,Input
...
# 构建LSTM-CNN模型
model = Sequential()
model.add(Bidirectional(LSTM(64, return_sequences=True))(input_layer))
...
# 保存模型为 HDF5 文件
# 保存模型
with h5py.File("model_custom12.h5", "w") as hf:
