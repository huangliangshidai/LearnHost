...
def extract_feature(audio_data, sample_rate):
    ...
    weighted_mfccs = 0.3 * mfccs + 0.3 * delta_mfccs + 0.3 * delta2_mfccs

    # 返回动态MFCCs特征
    return weighted_mfccs

# 1728/1728 [==============================] - 62s 36ms/step - loss: 0.6614 - accuracy: 0.7569 - val_loss: 0.6250 - val_accuracy: 0.7800
# 119
# 1728/1728 [==============================] - 60s 35ms/step - loss: 0.6693 - accuracy: 0.7543 - val_loss: 0.6446 - val_accuracy: 0.7767
# 训练模型
# 432/432 [==============================] - 7s 16ms/step - loss: 0.6446 - accuracy: 0.7767
# Test loss: 0.6446
# Test accuracy: 0.7767
# 模型评估
# 进行预测
# Class 0 Test Accuracy: 0.8398
# Class 1 Test Accuracy: 0.7965
# Class 2 Test Accuracy: 0.7212
# Class 3 Test Accuracy: 0.6778
# Class 4 Test Accuracy: 0.8928
# Class 5 Test Accuracy: 0.6751
# Class 6 Test Accuracy: 0.8298
# Class 7 Test Accuracy: 0.7255
# Class 8 Test Accuracy: 0.8664
# Class 9 Test Accuracy: 0.7412
