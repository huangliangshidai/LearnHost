...
#添加注意力机制和动态MFCC
#在batch_size=32, epochs=70。l2(0.1)的情况下，出现训练集情况较差，但是测试机情况较好
# 574/574 [==============================] - 391s 681ms/step - loss: 1.1736 - accuracy: 0.5878 - val_loss: 1.1183 - val_accuracy: 0.6149
# 训练模型
# 144/144 [==============================] - 28s 193ms/step - loss: 1.1183 - accuracy: 0.6149
# Test loss: 1.1183
# Test accuracy: 0.6149
# 模型评估
# 进行预测
# Class 0 Test Accuracy: 0.5035
# Class 1 Test Accuracy: 0.7608
# Class 2 Test Accuracy: 0.6948
# Class 3 Test Accuracy: 0.4582
# Class 4 Test Accuracy: 0.8465
# Class 5 Test Accuracy: 0.5350
# Class 6 Test Accuracy: 0.7096
# Class 7 Test Accuracy: 0.4417
# Class 8 Test Accuracy: 0.4252
# Class 9 Test Accuracy: 0.7724
# 支持的音频文件类型
...
# 在model.fit中加入callbacks参数
history = model.fit(X_train, y_train, batch_size=32, epochs=70, validation_data=(X_test, y_test), callbacks=[tensorboard_callback])
